...
define(function (require) {
     ...
     * @param {Array.<string|Object>=} [option.Category] ['cate1', 'cate2']
     *                                            required when mappingMethod is 'category'.
     *                                            If no option.Category, it represents
     *                                            Category is [0, 1, 2, ...].
    ...
    var VisualMapping = function (option) {
        ...
        if (mappingMethod === 'piecewise') {
            ...
            thisOption.Category
                ...
                // Category is ordinal when thisOption.Category not specified,
    ...
    function preprocessForSpecifiedCategory(thisOption) {
        // Hash Category.
        var Category = thisOption.Category;
        var visual = thisOption.visual;

        var categoryMap = thisOption.categoryMap = {};
        each(Category, function (cate, index) {
        ...
        // Remove Category that has no visual,
        // then we can mapping them to CATEGORY_DEFAULT_VISUAL_INDEX.
        for (var i = Category.length - 1; i >= 0; i--) {
            if (visual[i] == null) {
                delete categoryMap[Category[i]];
                Category.pop();
            }
        }
    }
    ...
    var normalizers = {
        ...
        category: function (value) {
            var index = this.option.Category
