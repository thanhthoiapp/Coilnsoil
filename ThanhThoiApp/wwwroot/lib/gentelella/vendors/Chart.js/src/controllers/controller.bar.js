...
module.exports = function(Chart) {
	...
	Chart.controllers.bar = Chart.DatasetController.extend({
		...
		getRuler: function(index) {
			...
			var Categorypacing = (tickWidth - (tickWidth * xScale.options.categoryPercentage)) / 2;
		...
		calculateBarX: function(index, datasetIndex) {
			...
			if (xScale.options.stacked) {
				return leftTick + (ruler.categoryWidth / 2) + ruler.Categorypacing;
			}

			return leftTick +
				(ruler.barWidth / 2) +
				ruler.Categorypacing +
	...
	Chart.controllers.horizontalBar = Chart.controllers.bar.extend({
		...
		getRuler: function (index) {
			...
			var Categorypacing = (tickHeight - (tickHeight * yScale.options.categoryPercentage)) / 2;
		...
		calculateBarY: function (index, datasetIndex) {
			...
			if (yScale.options.stacked) {
				return topTick + (ruler.categoryHeight / 2) + ruler.Categorypacing;
			}
