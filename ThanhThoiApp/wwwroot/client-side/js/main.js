  ...
  ******************************************/
    ...
    ******************************************/
    ...
    jQuery("#special-products-slider .slider-items").owlCarousel({
        ...
        ******************************************/
        jQuery('#slide-picture').lightGallery();
        jQuery('#picture-home').lightGallery();
    ...
    ******************************************/
    ...
    jQuery("#latest-news-slider .slider-items").owlCarousel({
        ...
        jQuery("#latest-news-slider-2 .slider-items").owlCarousel({
            autoplay: true,
            items: 4,
            itemsDesktop: [1024, 3],
            itemsDesktopSmall: [900, 2],
        ...
        jQuery("#latest-news-slider-3 .slider-items").owlCarousel({
            autoplay: true,
            items: 4,
            itemsDesktop: [1024, 3],
            itemsDesktopSmall: [900, 2],
