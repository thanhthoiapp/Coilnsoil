var CategoryController = function () {
    ...
    function registerEvents() {
        ...
        $('body').on('click', '#btnEdit', function (e) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#txtPathM').val(data.Path);

                    initTreeDropDownCategory(data.CategoryId);
                    $('#txtDescM').val(data.Description);
                    $('#ddlCategoryTypeIdM').val(data.Type);
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                var path = $('#txtPathM').val();
                var parentId = $('#ddlCategoryIdM').combotree('getValue');
                var categorytype = $('#ddlCategoryTypeIdM :selected').val();
    ...
    //function initTreeDropDownCategoryType(selectedId) {
    //    $.ajax({
    ...
    //            });
    //            var arr = tedu.unflattern(data);
    //            $('#ddlCategoryTypeIdM').combotree({
    //                data: arr
    //            });
    //            if (selectedId != undefined) {
    //                $('#ddlCategoryTypeIdM').combotree('setValue', selectedId);
    //            }
    //        }
    //    });
    //}
                ...
                $('#treeCategory').tree({
                    ...
                    onDrop: function (target, source, point) {
                        ...
                        if (point === 'append') {
                            ...
                            //Update to database
                            $.ajax({
                                url: '/Admin/Category/UpdateParentId',
                                type: 'post',
                                dataType: 'json',
                                data: {
                                    sourceId: source.id,
