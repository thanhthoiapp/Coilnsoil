        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(response, function (i, item) {
                    render += '<div class="col-md-3"><img width="100" src="' + item.Name + '"><br/><a href="#" class="btn-delete-image">Xóa</a></div>'
                });
