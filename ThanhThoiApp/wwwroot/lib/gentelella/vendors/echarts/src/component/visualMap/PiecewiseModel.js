define(function(require) {
    ...
    var PiecewiseModel = VisualMapModel.extend({
         ...
         * Order Rule:
         *
         * option.Category / option.pieces / option.text / option.selected:
         *     If !option.inverse,
        ...
        defaultOption: {
            selected: null,             // Object. If not specified, means selected.
                                        ...
                                        // When Category: {'cate1': false, 'cate3': true}
            ...
            Category: null,           // category names, like: ['some1', 'some2', 'some3'].
                                        // Attr min/max are ignored when Category set. See "Order Rule"
        ...
        doMergeOption: function (newOption, isInit) {
            ...
            this.resetVisual(function (mappingOption, state) {
                if (mode === 'Category') {
                    ...
                    mappingOption.Category = zrUtil.clone(Category);
                }
                else {
    ...
    var resetMethods = {
        ...
        Category: function () {
            var thisOption = this.option;
            zrUtil.each(thisOption.Category, function (cate) {
