	...
	'use strict';
	            ...
	            : function (itemOpt, dimName, dataIndex, dimIndex) {
	                ...
	                if (categoryDimIndex === dimIndex) {
	                    ...
	                    if (typeof val === 'string') {
	                        // Lazy get Category
	                        Category = Category || categoryAxisModel.getCategory();
	                        val = zrUtil.indexOf(Category, val);
	                        if (val < 0 && !isNaN(val)) {
	    ...
	    function createNameList(result, data) {
	        ...
	        if (result && result.categoryAxisModel) {
	            ...
	            var Category = result.categoryAxisModel.getCategory();
	            if (Category) {
	                ...
	                if (zrUtil.isArray(data[0]) && data[0].length > 1) {
	                    ...
	                    for (var i = 0; i < dataLen; i++) {
	                        nameList[i] = Category[data[i][result.categoryIndex || 0]];
	                    }
	                }
	                else {
	                    nameList = Category.slice(0);
	                }
	            }
	        }
	            ...
	            switch (axisType) {
	                ...
	                case 'category':
	                    return new OrdinalScale(
	                        model.getCategory(), [Infinity, -Infinity]
	                    );
	                case 'value':
